...
public class ObfuscatedStateMapper implements ASMCommon, IStateMapper {
    ...
    public String getSrgMethodName(String parentClassName, String methodName, String methodDescriptor) {
        try {
            ...
            LOGGER.warn("Could not lookup srg name for method '" + parentClassName + "::" + methodName + methodDescriptor + "'");
            return null;
        }
    }
    ...
    public String getObfMethodName(String parentClassName, String methodName, String methodDescriptor) {
        try {
            ...
            LOGGER.warn("Could not lookup obf name for method '" + parentClassName + "::" + methodName + methodDescriptor + "'");
            return null;
        }
    }
    ...
    public String getSrgFieldName(String parentClassName, String fieldName) {
        try {
            ...
            LOGGER.warn("Could not lookup srg name for field '" + parentClassName + "." + fieldName + "'");
            return null;
        }
    }
    ...
    public String getObfFieldName(String parentClassName, String fieldName) {
        try {
            ...
            LOGGER.warn("Could not lookup obf name for field '" + parentClassName + "." + fieldName + "'");
            return null;
        }
    }
