...
public class FileDumper {
    ...
    private static void dumpMcpTypeMap(File dumpLocation, final Map<String, Map<String, ObfuscatedStateMapper.McpTypeData>> mapIn) {
        dump(dumpLocation, writer -> {
            final StringBuilder builder = new StringBuilder();
            mapIn.entrySet()
                    .stream()
    ...
    public static void dumpAllFiles() {
        ...
        Class<?>[] constants = new Class[] {TypesMc.Classes.class, TypesMc.Fields.class, TypesMc.Methods.class, TypesHook.Classes.class, TypesHook.Fields.class, TypesHook.Methods.class};
