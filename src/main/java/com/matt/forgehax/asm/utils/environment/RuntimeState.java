...
public class RuntimeState {
    ...
    /**
     * Always assume the state is obfuscated because core minecraft classes will load before forge feeds us the obfuscation state
     */
    private static ThreadLocal<State> localState = ThreadLocal.withInitial(RuntimeState::getDefaultState);
