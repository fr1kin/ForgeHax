...
@Transformer(RenderChunk.class)
public class RenderChunkPatch {

    @Inject(name = "rebuildChunk", args = {float.class, float.class, float.class, ChunkCompileTaskGenerator.class},
    description = "Add hooks before and after blocks are added to the buffer"
    )
    public void rebuildChunk(MethodNode main) {
    ...
    @Inject(name = "deleteGlResources",
    description = "Add hook callback at top of method"
    )
    public void deleteGlResources(MethodNode main) {
