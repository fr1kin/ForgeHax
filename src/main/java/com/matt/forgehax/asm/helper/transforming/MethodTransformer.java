...
public abstract class MethodTransformer implements ASMCommon {
    ...
    public boolean equals(Object obj) {
        return obj instanceof MethodTransformer &&
                this.getMethod().getRuntimeName().equals(((MethodTransformer) obj).getMethod().getRuntimeName()) &&
                this.getMethod().getDescriptor().equals(((MethodTransformer) obj).getMethod().getDescriptor());
    }
    ...
    public String toString() {
        ...
        builder.append(getMethod() != null ? getMethod().getName()  : "null");
        builder.append("] ");
