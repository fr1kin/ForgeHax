...
public class MacroCommand extends CommandMod {
    ...
    public final Options<MacroEntry> MACROS = GLOBAL_COMMAND.builders().<MacroEntry>newOptionsBuilder()
            .name("macros")
    ...
    public void onLoad() {
        ...
        MACROS.builders().newCommandBuilder()
                .name("remove")
    ...
    public Command executeMacro(CommandBuilders builder) {
        return builder.newCommandBuilder()
                ...
                .processor(data -> {
                    ...
                    final MacroEntry macro = MACROS.stream()
    ...
    public Command bindMacro(CommandBuilders builder) {
        return builder.newCommandBuilder()
                ...
                .processor(data -> {
                    ...
                    final MacroEntry macro = new MacroEntry((String)data.getOption("name"), key, commands);
                    MACROS.stream()
