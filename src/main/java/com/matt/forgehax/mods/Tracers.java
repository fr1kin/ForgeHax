...
public class Tracers extends ToggleMod implements Colors {
    ...
    public final Setting<Mode> mode = getCommandStub().builders().<Mode>newSettingEnumBuilder()
            .name("mode")
            .description("Tracer drawing mode")
            .defaultTo(Mode.ARROWS)
            .build();

    public final Setting<Integer> alpha = getCommandStub().builders().<Integer>newSettingBuilder()
            .name("alpha")
    ...
    public final Setting<Boolean> antialias = getCommandStub().builders().<Boolean>newSettingBuilder()
            .name("antialias")
    ...
    public void onDrawScreen(Render2DEvent event) {
        ...
        getWorld().loadedEntityList.stream()
                ...
                .forEach(er -> {
                    ...
                    Vec3d entityPos = EntityUtils.getInterpolatedEyePos(entity, MC.getRenderPartialTicks());
