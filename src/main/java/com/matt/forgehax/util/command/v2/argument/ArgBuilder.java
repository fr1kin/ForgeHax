...
public class ArgBuilder<E> {
  ...
  /**
   * Description for this argument. Preferably with details. Not required. If not provided, it will
  ...
  /**
   * A shorter description that can be used in the syntax helper. Not required. If not provided, it
  ...
  /**
   * The default value for this argument. Not required and can be null. Will automatically set the
   * converter if that has not been done already.
   *
