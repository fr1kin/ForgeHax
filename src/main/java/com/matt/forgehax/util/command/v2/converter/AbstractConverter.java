...
public abstract class AbstractConverter<E> implements IConverter<E> {
  ...
  public void serialize(JsonWriter writer, @Nullable E instance) throws IOException {
    if (instance == null) writer.nullValue();
    else writer.value(toString(instance));
  }
  ...
  public E deserialize(JsonReader reader) throws IOException {
    if (reader.peek() == JsonToken.NULL) {
      reader.skipValue();
      return null;
    } else return valueOf(reader.nextString());
  }
  ...
  public boolean equals(Object obj) {
    return this == obj
        || (obj instanceof IConverter
            && Objects.equals(getType(), ((IConverter) obj).getType())
            && Objects.equals(getPrimitiveType(), ((IConverter) obj).getPrimitiveType()));
  }
