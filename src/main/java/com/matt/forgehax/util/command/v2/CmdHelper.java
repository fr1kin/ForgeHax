...
public class CmdHelper {
    ...
    public static void requireArgument(String[] args, ICmd cmd, IArg<?> arg) throws CmdMissingArgumentException {
    ...
    public static <T extends ICmd> T registerAll(T cmd, Iterable<ICmdCallback> callbacks, Iterable<Enum<? extends ICmdFlag>> flags) {
