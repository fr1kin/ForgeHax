...
public interface IConverter<E> extends ValuesConverter<E>, ValueConverter<E>, StringConverter<E>, Comparator<E>, ISerializableImmutable<E> {
    /**
    ...
    final class Builder<E> {
        ...
        /**
         * A function that collects all the possible values from a given string.
         * If not provided, one will be automatically generated provided valueOf() is nonnull.
        ...
        /**
         * A function that gets the most probable value of this object from a given string.
         * If not provided, one will be automatically generated provided valuesOf() is nonnull.
         * @param function conversion function
         * @return this
         */
        ...
        public IConverter<E> build() {
            if(_valueConverter == null && _valuesConverter == null)
                throw new NullPointerException("Cannot build without a value and/or values converter provided");

            if(_valuesConverter == null)
                _valuesConverter = ((input, stream) -> Stream.of(_valueConverter.valueOf(input)));

            if(_valueConverter == null)
                _valueConverter = ((input, stream) -> _valuesConverter.valuesOf(input).findFirst().orElse(null));

            return new BaseConverter<>(_type, _primitiveType, _label, _comparator, _valuesConverter, _valueConverter, _stringConverter, _serializer);
        }
    }
}