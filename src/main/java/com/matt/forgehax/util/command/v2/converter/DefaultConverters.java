...
public interface DefaultConverters {
    IConverter<Boolean> BOOLEAN = new AbstractConverter<Boolean>() {
        private final String ACCEPTABLE_TRUE_BOOLEAN_STRINGS = Stream.of("on", "t", "tr", "tru", "true", "e", "en", "ena", "enab", "enabl", "enable", "enabled", "1").collect(Collectors.joining("|"));
        ...
        @Override
        public Stream<Boolean> valuesOf(String input, Stream<Boolean> stream) throws ValueParseException {
    ...
    IConverter<Byte> BYTE = new AbstractConverter<Byte>() {
        @Override
    ...
    IConverter<Character> CHARACTER = new AbstractConverter<Character>() {
        @Override
        ...
        @Nullable
        @Override
        public Character valueOf(String input, Stream<Character> stream) throws ValueParseException {
            ValueParseException.requireNonNull(input);
            if(input.length() != 1) throw new ValueParseException(new IllegalArgumentException("String \"" + String.valueOf(input) + "\" must be 1 character in length"));
    ...
    IConverter<Double> DOUBLE = new AbstractConverter<Double>() {
        @Override
    ...
    IConverter<Float> FLOAT = new AbstractConverter<Float>() {
        @Override
    ...
    IConverter<Integer> INTEGER = new AbstractConverter<Integer>() {
        @Override
        ...
        @Override
        public Stream<Integer> valuesOf(String input, Stream<Integer> stream) throws ValueParseException {
            return Stream.of(valueOf(input));
        }
    ...
    IConverter<Long> LONG = new AbstractConverter<Long>() {
        @Override
    ...
    IConverter<Short> SHORT = new AbstractConverter<Short>() {
        @Override
        ...
        @Override
        public Stream<Short> valuesOf(String input, Stream<Short> stream) throws ValueParseException {
            return Stream.of(valueOf(input));
        }
    ...
    IConverter<String> STRING = new AbstractConverter<String>() {
        @Override
        ...
        @Override
        public Stream<String> valuesOf(String input, Stream<String> stream) throws ValueParseException {
            return Stream.of(valueOf(input));
        }
    ...
    IConverter<Object> EMPTY = new AbstractConverter<Object>() {
        @Override
        ...
        @Override
        public Stream<Object> valuesOf(String input, Stream<Object> stream) throws ValueParseException {
            return null;
        }
