...
public interface IBlockProperty extends ISerializableJson {
    /**
     * If the current mutable instance is containing unique data.
     * If this method returns false, then the property may be switched to
     * an immutable instance of itself.
    ...
    /**
     * Creates a new immutable instance of the class that doesn't allow
     * any data to be mutated from its default state.
