...
public class BlockEntry implements ISerializableJson, Globals {
    ...
    public String getResourceName() {
        return block != null ? (block.getRegistryName() != null ? block.getRegistryName().toString() : block.toString()) : Strings.EMPTY;
    }

    public String getPrettyName() {
        return block != null ? ((block.getRegistryName() != null ? block.getRegistryName().getResourcePath() : block.toString()) + (isMetadata() ? ":" + meta : Strings.EMPTY)) : Strings.EMPTY;
    }
    ...
    private <T extends IBlockProperty> T getProperty(@Nonnull Class<T> clazz, OpenMode mode) {
        switch (mode) {
            ...
            case WRITE:
                return properties.computeIfAbsent(clazz, c -> {
     ...
     * unique property for the entry in question, an immutable entry will be returned.
     * Mutating data is possible, but is not safe. If you need to mutate data use getWritableProperty
    ...
    /**
     * Allows null pointer free reading AND writing of the property in question. If this class does not have a
     * unique property for the entry in question, an immutable entry will be returned.
     * @param clazz Property class to access
     * @param <T> Property type
     * @return instance of the class in question
    ...
    /**
     * Unregisters any property that is not necessary.
     * Call this after using getWritableProperty
     */
    public void cleanupProperties() {
        for(IBlockProperty property : properties.values()) if(!property.isNecessary())
    ...
    public boolean equals(Object obj) {
        if(obj instanceof BlockEntry)
            ...
            return isEqual(((IBlockState) obj).getBlock(), ((IBlockState) obj).getBlock().getMetaFromState((IBlockState) obj));
