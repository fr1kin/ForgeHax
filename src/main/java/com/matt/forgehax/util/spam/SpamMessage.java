...
public class SpamMessage implements Comparable<SpamMessage> {
    ...
    public SpamMessage(String message, String type, long delay, String activator, PriorityEnum priority) {
    ...
    public boolean equals(Object obj) {
        return obj == this ||
                (obj instanceof SpamMessage && activator != null && ((SpamMessage) obj).activator != null && activator.equalsIgnoreCase(((SpamMessage) obj).activator));
    }
