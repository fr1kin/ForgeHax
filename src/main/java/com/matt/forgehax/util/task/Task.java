...
public class Task implements Comparable<Task> {
    private final Multimap<Type, Consumer<IProcess.DataEntry>> pre = Multimaps.newListMultimap(Maps.newHashMap(), Lists::newArrayList);
    private final Multimap<Type, Consumer<IProcess.DataEntry>> post = Multimaps.newListMultimap(Maps.newHashMap(), Lists::newArrayList);
