...
public class OldUtils implements Globals {
  ...
  public static Angle getLookAtAngles(Vec3d end) {
    return getLookAtAngles(OldEntityUtils.getEyePos(getLocalPlayer()), end);
  }

  public static Angle getLookAtAngles(Entity entity) {
    return getLookAtAngles(OldEntityUtils.getOBBCenter(entity));
  }
  ...
  public static class Colors {
    public static final int WHITE = OldUtils.toRGBA(255, 255, 255, 255);
    public static final int BLACK = OldUtils.toRGBA(0, 0, 0, 255);
    public static final int RED = OldUtils.toRGBA(255, 0, 0, 255);
    public static final int GREEN = OldUtils.toRGBA(0, 255, 0, 255);
    public static final int BLUE = OldUtils.toRGBA(0, 0, 255, 255);
    public static final int ORANGE = OldUtils.toRGBA(255, 128, 0, 255);
    public static final int PURPLE = OldUtils.toRGBA(163, 73, 163, 255);
    public static final int GRAY = OldUtils.toRGBA(127, 127, 127, 255);
    public static final int DARK_RED = OldUtils.toRGBA(64, 0, 0, 255);
    public static final int YELLOW = OldUtils.toRGBA(255, 255, 0, 255);
  }
}
