...
public class ASMClassBuilder implements ASMCommon {
    ...
    public ASMClassBuilder setClassName(String internalClassName) {
        return setClassName(!Strings.isNullOrEmpty(internalClassName) ? Type.getObjectType(internalClassName) : null);
    }
    ...
    public ASMClassBuilder setObfuscatedClassName(String obfuscatedInternalClassName) {
        obfuscatedName = !Strings.isNullOrEmpty(obfuscatedInternalClassName) ? Type.getObjectType(obfuscatedInternalClassName) : null;
        return this;
    }
