...
public class PrePostBlockModelRenderEvent extends Event {
    ...
    public PrePostBlockModelRenderEvent(RenderChunk renderChunk, BufferBuilder BufferBuilder, State state, Vec3d pos) {
    ...
    public PrePostBlockModelRenderEvent(RenderChunk renderChunk, BufferBuilder BufferBuilder, State state, BlockPos pos) {
