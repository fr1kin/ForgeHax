 ...
 *
 * TODO: replace Angle.java with this
 */
public class AngleN {
    ...
    public boolean equals(Object obj) {
        if(this == obj) {
            ...
            if(self.isRadians() != ang.isRadians()) ang = self.isRadians() ? ang.toRadians() : ang.toDegrees();
    ...
    public String toString() {
        return String.format("(%.15f, %.15f, %.15f)[%s]", pitch(), yaw(), roll(), isRadians() ? "rad" : "deg");
    }
}
