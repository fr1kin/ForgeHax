...
public class PropertyFactory {
    private static final Map<Class<? extends IBlockProperty>, Supplier<? extends IBlockProperty>> PROPERTY_FACTORY = Maps.newHashMap();
    private static final Map<Class<? extends IBlockProperty>, IBlockProperty> CLASS_TO_IMMUTABLE = Maps.newHashMap();
    private static final Map<String, Class<? extends IBlockProperty>> HEADING_TO_CLASS = Maps.newHashMap();

    public static void registerPropertyFactory(Class<? extends IBlockProperty> clazz, Supplier<? extends IBlockProperty> factory) {
